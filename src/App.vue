  ...
  methods:{
    ...
    getAvatar(id){
      //if(typeof this.state.userInfo[id] == 'undefined' || !this.state.userInfo[id].avatar){
        return this.state.loggedIn ? (this.state.loggedInUser.avatar == this.state.defaultAvatar ? `${this.state.URLbase}/` + this.state.loggedInUser.avatar : this.loggedInUser.avatar) : `${this.state.URLbase}/` + this.state.defaultAvatar
      //} else {
